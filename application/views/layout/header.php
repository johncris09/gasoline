    ...
    <header class="app-header app-header-dark">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand">
            ...
            <a href="<?php echo base_url(); ?>">Gaso<span style="color: #F7C46C">line</span> </a>
          </div><!-- /.top-bar-brand -->
          <!-- .top-bar-list -->
