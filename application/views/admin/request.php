...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/datatable/css/select.bootstrap5.min.css">
  ...
  <script src="<?php echo base_url() ?>assets/javascript/request.js"></script>
